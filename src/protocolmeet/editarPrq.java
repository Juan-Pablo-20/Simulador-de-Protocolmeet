...
public class editarPrq extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(telText, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 282, 373, -1));

        jLabel6.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("Correo");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 312, -1, -1));

        corrText.setBackground(new java.awt.Color(204, 255, 255));
        getContentPane().add(corrText, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 337, 373, -1));

        jLabel10.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Dirección");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 92, -1, -1));

        dircText.setBackground(new java.awt.Color(204, 255, 255));
        getContentPane().add(dircText, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 117, 373, -1));

        jLabel7.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Capacidad maxima de personas");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 147, -1, -1));

        capText.setBackground(new java.awt.Color(204, 255, 255));
        getContentPane().add(capText, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 172, 373, -1));

        jLabel8.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("NIT de la parroquia");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 202, -1, -1));

        nitText.setBackground(new java.awt.Color(204, 255, 255));
        getContentPane().add(nitText, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 227, 373, -1));

        jLabel9.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Contraseña");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 257, -1, -1));
        ...
        getContentPane().add(passText, new org.netbeans.lib.awtextra.AbsoluteConstraints(503, 282, 373, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        parroquia np = new parroquia(reservar.dio, reservar.namepa, reservar.namepo, reservar.telf, reservar.cor, reservar.dir, reservar.capa, reservar.nitt, reservar.psw);
        try {
            base2.update(np);
